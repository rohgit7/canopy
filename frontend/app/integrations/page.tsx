...
export default function IntegrationsPage() {
  return (
    <PageLayout title="Integrations" subtitle="Connect Canopy to your existing tools and workflows">
      <div style={{ background: '#1e2736', border: '1px solid #1a2d45', borderLeft: '4px solid var(--aws-orange)', borderRadius: 8, padding: 14, marginBottom: 24, fontSize: 12, color: 'var(--aws-orange)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 14 }}>
        {INTEGRATIONS.map(intg => (
          <div key={intg.name} style={{ background: '#1e2736', border: '1px solid #1a2d45', borderRadius: 8, padding: 18 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
              <div style={{ width: 38, height: 38, borderRadius: 8, background: '#1e2736', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <div>
                ...
                <span style={{ fontSize: 9, padding: '2px 6px', borderRadius: 4, background: '#1e2736', color: '#455a64' }}>COMING SOON</span>
              </div>
            </div>
